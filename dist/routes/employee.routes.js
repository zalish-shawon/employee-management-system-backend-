...
const empCtrl = __importStar(require("../controllers/employee.controller"));
const auth_middleware_1 = require("../middleware/auth.middleware");
const validate_middleware_1 = require("../middleware/validate.middleware");
const employee_validator_1 = require("../validators/employee.validator");
const router = (0, express_1.Router)();
router.get('/allEmployees', auth_middleware_1.authenticate, (0, auth_middleware_1.authorize)(['admin', 'hr', 'manager']), empCtrl.listEmployees);
router.post('/create-employee', auth_middleware_1.authenticate, (0, auth_middleware_1.authorize)(['admin', 'hr']), (0, validate_middleware_1.validate)(employee_validator_1.createEmployeeSchema), empCtrl.createEmployee);
